...
#SBATCH --partition=q3d              # node005 belongs to this partition
#SBATCH --gres=gpu:1                  # Requesting 1 of the 8 available GPUs
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8            # Use 16 of the 28 free CPUs for fast patching
#SBATCH --mem=32G                    # High RAM for image processing
